...
const ConfirmOrder = ({ history }) => {
  ...
  return (
    <Fragment>
      ...
      <div className="confirmOrderPage p-14 flex flex-wrap justify-normal">
        <div className="w-[60%]">
        ...
        <div className="border-solid border-t-[1px] w-[1px] ml-14  transform-rotate-90  bg-zinc-400"></div>
        {/*  */}
